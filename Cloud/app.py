...
def covid_10():
    ...
    #fig.show()
    fig.write_html("templates/choro.html")
...
def covid_11():
    ...
    fig.update(layout_coloraxis_showscale=False)
    fig.write_html("templates/choro11.html")
    return render_template("choro11.html")
...
def covid_12():
    ...
    #fig.savefig(img)
    #img.seek(0)
    fig.write_html("templates/choro12.html")
    return render_template("choro12.html")
...
def covid_13():
    ...
    #fig.savefig(img)
    #img.seek(0)
    fig.write_html("templates/choro13.html")
    return render_template("choro13.html")
...
def covid_14():
    ...
    fig.update(layout_coloraxis_showscale=False)
    #fig.show()
    fig.write_html("templates/choro14.html")
    return render_template("choro14.html")
...
def covid_15():
    ...
    fig.update(layout_coloraxis_showscale=False)
    #fig.show()
    fig.write_html("templates/choro15.html")
    return render_template("choro15.html")
...
def covid_16():
    ...
    fig.data[0].textinfo = 'label+text+value'
    #fig.show()
    fig.write_html("templates/choro16.html")
    return render_template("choro16.html")
...
def covid_17():
    ...
    fig.data[0].textinfo = 'label+text+value'
    #fig.show()
    fig.write_html("templates/choro17.html")
    return render_template("choro17.html")
...
def covid_18():
    ...
    fig.update(layout_coloraxis_showscale=False)
    #fig.show()
    fig.write_html("templates/choro18.html")
    return render_template("choro18.html")
...
def covid_19():
    ...
    fig.update(layout_coloraxis_showscale=False)
    #fig.show()
    fig.write_html("templates/choro19.html")
    return render_template("choro19.html")
...
def covid_20():
    ...
    fig.data[0].textinfo = 'label+text+value'
    #fig.show()
    fig.write_html("templates/choro20.html")
    return render_template("choro20.html")
...
def covid_26():
    global fig3
    fig.write_html("templates/choro22.html")
...
def covid_23():
    ...
    fig.update_layout(uniformtext_minsize=8, uniformtext_mode='hide')
    #fig.show()
    fig.write_html("templates/choro23.html")
    return render_template("choro23.html")
...
def covid_24():
    ...
    fig.update_layout(uniformtext_minsize=8, uniformtext_mode='hide')
    #fig.show()
    fig.write_html("templates/choro24.html")
    return render_template("choro24.html")
...
def covid_25():
    ...
    fig.update_layout(uniformtext_minsize=8, uniformtext_mode='hide')
    #fig.show()
    fig.write_html("templates/choro25.html")
    return render_template("choro25.html")
